...
function App() {
  ...
  const getAllMovies = async () => {
    try {
      const res = await axios.get(
        "https://api.themoviedb.org/3/movie/popular?api_key=22006fdc6740588ec8f99ce0772f459e&language=en-US"
      );
  ...
  const search = async (word) => {
    if (word === "") {
      ...
      const res = await axios.get(
        `https://api.themoviedb.org/3/search/movie?api_key=22006fdc6740588ec8f99ce0772f459e&language=en-US&query=${word}`
      );
      setMovies(res.data.results);
      setCount(res.data.total_pages);
    }
